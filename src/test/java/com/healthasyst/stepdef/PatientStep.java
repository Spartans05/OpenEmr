package com.healthasyst.stepdef;
...
public class PatientStep {
	...
	public void i_fill_the_form(io.cucumber.datatable.DataTable dataTable) {
		...
		WebDriverWrapper.driver.findElement(By.id("form_DOB")).sendKeys("2021-02-05");
		
		Select selectGender = new Select(WebDriverWrapper.driver.findElement(By.id("form_sex")));
